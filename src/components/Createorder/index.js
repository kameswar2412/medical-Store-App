...
import { createOrder, emptyCart,addToCart } from '../../redux/actions'


const COrder = ({ create_order, add_to_cart, cartItem, empty_cart }) => {
    ...
    return (<div className="d-flex">
        ...
        <h1 style={{ margin: "20px", textAlign: "center", marginLeft: "-25px" }}>Make an Order</h1>
       
        <div style={{ display: "flex", justifyContent: "center" }}>
            
        <div className="add_to_cart" style={{marginLeft:"25px"}}>
                
                <label type="text" onChange={(e) => setAddToCartName(e.target.value)}>Medicine 
                <input  />
                
                </label>
               
               
                <label onChange={(e) => setAddToCartQty(e.target.value)}>Quantity
            ...
            <form className="create_order_form form1" onSubmit={handleFormSubmit}>
...
export default connect(mapStateToProps, mapDispatchToProps)(COrder)
